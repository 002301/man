/*
  ...
  * 
  * 
import com.man.ScrollBar;

var myScroll:ScrollBar=new ScrollBar(contMc,tmask,hua,listbg);
...
myScroll.UP=up;				 //分配上/左((L版/H版)滚动条按钮,不需要此按钮可以去除
myScroll.DOWN=down;		     //分配下/右((L版/H版)滚动条按钮,不需要此按钮可以去除
myScroll.stepNumber=15;				 //步数——包括鼠标滚轮、点击滚动条背景、单击左右/上下按钮，所跳动的距离，单位为像素。[默认:15]
